        ...
        const arabicTeachers = ['Nidaa', 'Dina', 'Hana', 'Amal Najar', 'Abeer', 'Fatima Zahrani'];
        const englishTeachers = ['Amal', 'Nouf', 'Farah'];
        ...
        function initializeApp(username) {
            ...
            if (loggedInUser === 'Mohamed' || loggedInUser === 'Rasha') { 
